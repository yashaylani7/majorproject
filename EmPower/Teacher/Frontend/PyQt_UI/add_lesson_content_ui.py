...
"background-color: rgb(137, 218, 199);")
    ...
    def retranslateUi(self, Form):
        ...
        self.lbl_heading.setText(QCoreApplication.translate("Form", "Create Module Content", None))
        self.lbl_category.setText(QCoreApplication.translate("Form", "Category", None))
        self.cmb_category.setItemText(0, QCoreApplication.translate("Form", "Select a Category", None))
        self.cmb_category.setItemText(1, QCoreApplication.translate("Form", "Noun Learning (Noun)", None))
        self.cmb_category.setItemText(2, QCoreApplication.translate("Form", "Verb Learning (Verb)", None))
        self.cmb_category.setItemText(3, QCoreApplication.translate("Form", "Association Learning (Association)", None))
        self.cmb_category.setItemText(4, QCoreApplication.translate("Form", "Activity Learning (Activity)", None))

        self.lbl_lesson_id.setText(QCoreApplication.translate("Form", "Lesson ID", None))
        self.edit_lesson_id.setPlaceholderText(QCoreApplication.translate("Form", "e.g., 1", None))
        self.lbl_lesson_topic.setText(QCoreApplication.translate("Form", "Lesson Topic", None))
        self.edit_lesson_topic.setPlaceholderText(QCoreApplication.translate("Form", "e.g., Animals", None))
        self.btn_select_photo.setText(QCoreApplication.translate("Form", "Select Image/Video", None))
        # if QT_CONFIG(shortcut)
        self.btn_select_photo.setShortcut(QCoreApplication.translate("Form", "Return", None))
        # endif // QT_CONFIG(shortcut)
        self.lbl_photo_name.setText("")
        self.lbl_audio.setText("")
        self.btn_select_audio.setText(QCoreApplication.translate("Form", "Select Audio", None))
        # if QT_CONFIG(shortcut)
        self.btn_select_audio.setShortcut(QCoreApplication.translate("Form", "Return", None))
        # endif // QT_CONFIG(shortcut)
        self.lbl_or.setText(QCoreApplication.translate("Form", "Or", None))
        self.btn_record_audio.setText(QCoreApplication.translate("Form", "Record Audio", None))
        # if QT_CONFIG(shortcut)
        self.btn_record_audio.setShortcut(QCoreApplication.translate("Form", "Return", None))
        # endif // QT_CONFIG(shortcut)
        self.btn_submit.setText(QCoreApplication.translate("Form", "Submit Module", None))
        # if QT_CONFIG(shortcut)
        self.btn_submit.setShortcut(QCoreApplication.translate("Form", "Return", None))
        # endif // QT_CONFIG(shortcut)
