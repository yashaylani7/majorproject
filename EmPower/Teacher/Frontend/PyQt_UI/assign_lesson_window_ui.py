...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.lbl_heading.setText(QCoreApplication.translate("Form", "Assign Lesson to Student", None))
        self.lbl_category.setText(QCoreApplication.translate("Form", "Lesson", None))
        self.lsn_cmb_lesson_list.setItemText(0, QCoreApplication.translate("Form", "Select Lesson", None))

        self.lbl_category_2.setText(QCoreApplication.translate("Form", "Puzzle", None))
        self.lsn_cmb_puzzle_list.setItemText(0, QCoreApplication.translate("Form", "Select Puzzle", None))

        self.lbl_category_3.setText(QCoreApplication.translate("Form", "MCQ", None))
        self.lsn_cmb_mcq_list.setItemText(0, QCoreApplication.translate("Form", "Select MCQ", None))

        self.lbl_category_4.setText(QCoreApplication.translate("Form", "Sequence", None))
        self.lsn_cmb_sequence_list.setItemText(0, QCoreApplication.translate("Form", "Select Sequence", None))

        self.lbl_category_5.setText(QCoreApplication.translate("Form", "Matching", None))
        self.lsn_cmb_matching_list.setItemText(0, QCoreApplication.translate("Form", "Select Matching", None))

        self.lbl_lesson_id.setText(QCoreApplication.translate("Form", "Student ID", None))
        self.lsn_edit_student_id.setPlaceholderText("")
        self.lbl_lesson_topic.setText(QCoreApplication.translate("Form", "Student Name", None))
        self.lsn_edit_student_name.setPlaceholderText("")
        self.lsn_btn_assign_lsn_to_std.setText(QCoreApplication.translate("Form", "Assign Lesson", None))
        # if QT_CONFIG(shortcut)
        self.lsn_btn_assign_lsn_to_std.setShortcut(QCoreApplication.translate("Form", "Return", None))
