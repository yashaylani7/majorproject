...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.lbl_heading.setText(QCoreApplication.translate("Form", "Register Student Information", None))
        self.label.setText(QCoreApplication.translate("Form", "Student ID", None))
        self.input_id.setText("")
        self.input_id.setPlaceholderText("")
        self.label_2.setText(QCoreApplication.translate("Form", "Student Name", None))
        self.input_name.setPlaceholderText("")
        self.label_3.setText(QCoreApplication.translate("Form", "Student Age", None))
        self.input_age.setPlaceholderText("")
        self.label_4.setText(QCoreApplication.translate("Form", "Address", None))
        self.input_address.setPlaceholderText("")
        self.label_5.setText(QCoreApplication.translate("Form", "Guardian's Name", None))
        self.input_guardian.setPlaceholderText("")
        self.label_6.setText(QCoreApplication.translate("Form", "Guardian's Mobile Number", None))
        self.input_phone.setPlaceholderText("")
        self.btn_submit.setText(QCoreApplication.translate("Form", "Submit Information", None))
