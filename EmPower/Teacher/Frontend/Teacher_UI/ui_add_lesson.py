...
"background-color: rgb(137, 218, 199);")
    ...
    def retranslateUi(self, Form):
        ...
        self.cmb_category.setItemText(1, _translate("Form", "Learning Names (Noun)"))
        self.cmb_category.setItemText(2, _translate("Form", "Learning Actions (Verb)"))
        self.cmb_category.setItemText(3, _translate("Form", "Learning Relationships (Association)"))
        self.cmb_category.setItemText(4, _translate("Form", "Learning Activities (Activity)"))
        self.lbl_lesson_id.setText(_translate("Form", "Curriculum"))
        self.edit_lesson_id.setPlaceholderText(_translate("Form", "For example: 1"))
        self.lbl_lesson_topic.setText(_translate("Form", "Lesson Topic"))
        self.edit_lesson_topic.setPlaceholderText(_translate("Form", "For example: Mango"))
